...
typedef enum
{
	GPIOA_MODE_ADDR = 0x40020000,
	GPIOB_MODE_ADDR = 0x40020400,
	GPIOC_MODE_ADDR = 0x40020800,
	GPIOD_MODE_ADDR = 0x40020C00,
	GPIOE_MODE_ADDR = 0x40021000,
	GPIOH_MODE_ADDR = 0x40021C00,
} gpioMode_e;

typedef enum
{
	GPIOA_OUT_ADDR = GPIOA_MODE_ADDR + 0x14,
	GPIOB_OUT_ADDR = GPIOB_MODE_ADDR + 0x14,
	GPIOC_OUT_ADDR = GPIOC_MODE_ADDR + 0x14,
	GPIOD_OUT_ADDR = GPIOD_MODE_ADDR + 0x14,
	GPIOE_OUT_ADDR = GPIOE_MODE_ADDR + 0x14,
	GPIOH_OUT_ADDR = GPIOH_MODE_ADDR + 0x14,
} gpioOutput_e;
